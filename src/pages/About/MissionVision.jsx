    ...
    <div className="grid grid-cols-2">
      ...
      <div className="pl-8">
        <div className="w-4/5">
          ...
          <p className="mt-5 font-ubuntu text-white/60 tracking-wide leading-7">To become a global AI R&D hub focused on empowering differently abled and underserved communities—through deep research, thoughtful engineering, and real-world innovation.</p>
        </div>
      </div>
    </div>
  )
