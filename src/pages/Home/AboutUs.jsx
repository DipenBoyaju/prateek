      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-12 gap-10">
          ...
          <div className="col-span-7">
            <div className="border border-secondary/40 rounded-full w-fit text-sm py-1 px-5 flex items-center gap-2 uppercase font-geist tracking-wider text-white/60">About Us</div>
